...
export const fs3dataSchema = {
    ...
    IZZE_BRAKETEMP_S1_CH1: float32,
    IZZE_BRAKETEMP_S1_CH2: float32,
    IZZE_BRAKETEMP_S1_CH3: float32,
    IZZE_BRAKETEMP_S1_CH4: float32,
    IZZE_BRAKETEMP_S1_CH5: float32,
    IZZE_BRAKETEMP_S1_CH6: float32,
    IZZE_BRAKETEMP_S1_CH7: float32,
    IZZE_BRAKETEMP_S1_CH8: float32,
    IZZE_BRAKETEMP_S1_CH9: float32,
    IZZE_BRAKETEMP_S1_CH10: float32,
    IZZE_BRAKETEMP_S1_CH11: float32,
    IZZE_BRAKETEMP_S1_CH12: float32,
    IZZE_BRAKETEMP_S1_CH13: float32,
    IZZE_BRAKETEMP_S1_CH14: float32,
    IZZE_BRAKETEMP_S1_CH15: float32,
    IZZE_BRAKETEMP_S1_CH16: float32,
    IZZE_BRAKETEMP_S1_STEMP: float32,
    ACC_TRAY_TEMPS_BOLTED_CONNECTION: float32,
    ACC_TRAY_TEMPS_BUSBAR: float32,
    ACC_TRAY_TEMPS_PACK_FUSE: float32,
    ACC_TRAY_TEMPS_COWLING: float32,
    ACC_TRAY_TEMPS_INTAKE: float32,
};
